    ...
    try:
        ...
        try:
            if "computer_activityId" in event.message.text:
                ...
                await cmd('task Tivon521_yan_KR/jd_mhtask.js now')
            elif "jd_nzmhurl" in event.message.text:
                await cmd('task Tivon521_yan_KR/jd_nzmh.js now')
                ...
                await cmd('task Tivon521_yan_KR/m_jd_wx_collectCard.js now')
            elif "jd_cjhy_activityId" in event.message.text:
                await cmd('task Tivon521_yan_KR/jd_cjzdgf.js now')
            elif "jd_zdjr_activityId" in event.message.text:
                await cmd('task Tivon521_yan_KR/jd_zdjr.js now')
            elif "VENDER_ID" in event.message.text:
                await cmd('task Tivon521_yan_KR/jd_OpenCard_Force.js now')
            elif "WXGAME_ACT_ID" in event.message.text:
                await cmd('task Tivon521_yan_KR/jd_doudou.js now')
            elif "SHARE_ACTIVITY_ID" in event.message.text:
                await cmd('task Tivon521_yan_KR/jd_share.js now')
            elif "welfare" in event.message.text:
                await cmd('task Tivon521_yan_KR/fav_and_addcart.js now')
            elif "M_FOLLOW_SHOP_ARGV" in event.message.text:
                await cmd('task Tivon521_yan_KR/m_jd_follow_shop.js now')
            elif "M_WX_LUCK_DRAW_URL" in event.message.text:
                await cmd('task Tivon521_yan_KR/m_jd_wx_luckDraw.js now')
